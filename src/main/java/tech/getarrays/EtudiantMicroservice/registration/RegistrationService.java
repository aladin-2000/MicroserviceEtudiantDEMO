package tech.getarrays.EtudiantMicroservice.registration;


import lombok.AllArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import tech.getarrays.EtudiantMicroservice.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = etudiantService.addEtudiant(
                new Etudiant(
        ...
        String link = "http://localhost:8070/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        etudiantService.enableEtudiant(
                confirmationToken.getEtudiant().getEmail());
        return "confirmed";
    }
